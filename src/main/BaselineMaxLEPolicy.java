 ...
 * @author Wint Hnin
 */
public class BaselineMaxLEPolicy {
	...
	public BaselineMaxLEPolicy(HashMap<String,Float> sortedAllPuzzle_PredMap, PathwayPuzzle lastPuzzle, float lastPred, int lastCogL) {
